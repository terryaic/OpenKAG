...
class BaseRAG():
    ...
    def __init__(self, db_uri, dir, top_k=TOP_K, prompt=None):
        ...
        """if os.path.exists(db_uri):
            ...
            storage_context = StorageContext.from_defaults(vector_store=vector_store)"""
        self.storage_dir = dir.replace("res_files","storage")

        def build_docs(dir, storage_dir):
            ...
            return index
        self.index = build_docs(dir, self.storage_dir)
    ...
    def get_chat_engine(self, top_k=TOP_K):
